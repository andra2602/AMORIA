        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupDescription = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Private = table.Column<bool>(type: "bit", nullable: false),
                    GroupDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Max = table.Column<int>(type: "int", nullable: false),
                    ManagerGroupId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.GroupId);
                    table.ForeignKey(
                        name: "FK_Groups_AspNetUsers_ManagerGroupId",
                        column: x => x.ManagerGroupId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageVideoPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmbeddedVideoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_ManagerGroupId",
                table: "Groups",
                column: "ManagerGroupId");
